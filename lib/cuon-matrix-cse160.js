...
class Vector3 {
    ...
    add(other) {
        ...
        // ASSIGNMENT0
        for (let x=0; x<=3; x+= 1){
          this.elements[x] = (this.elements[x] + other.elements[x]);
        }
    ...
    div(scalar) {
        ...
        // ASSIGNMENT0
        for (let x=0; x<=3; x+=1){
          this.elements[x] = (this.elements[x] / scalar);
        }
    ...
    static dot(other1, other2) {
        ...
        for (let x=0; x<3; x+=1) {
          d += (other1.elements[x] * other2.elements[x]);
        }
        // Don't delete the return statement.
        return d;
    }
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([
          (other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1]),  // x component
          (other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2]),  // y component
          (other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0])   // z component
        ]);
        // Don't delete the return statement.
        return v3;
    }
    ...
    normalize() {
        ...
        // Normalize each element of the vector by dividing by the magnitude
        this.elements[0] /= mag;
        this.elements[1] /= mag;
        this.elements[2] /= mag;
